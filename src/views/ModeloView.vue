...
<template>
    <div>
        <div class="card">
            <cToolbar class="mb-4">
                <template #start>
                    <CustomButton label="Agregar Modelo" icon="pi pi-plus" severity="success" class="mr-2" @click="openNew" />
                </template>
            </cToolbar>
            ...
            <TabView>
                ...
                <TabPanel header="Información del vehiculo">
                    ...
                    <div class="formcont">
                        ...
                        <div class="flex align-items-center gap-3 mb-3">
                            <label for="tipo" class="font-semibold w-6rem">Transmision</label>
                            <DropDown size="small" id="tipo" v-model="selectedOption" :options="options"
                                optionLabel="name" placeholder="Tipos" class="drop" />
                        </div>
